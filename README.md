...
**For graders / external readers (English):**
...
**Internal team-process documentation (Chinese):**
- [目录结构](#目录结构)
- [团队分工](#团队分工)
- [Git 协作流程](#git-协作流程)
- [任务清单](#任务清单)
...
Design rationale and key decisions are recorded in [plan.md](plan.md) (internal Chinese-language design log).
