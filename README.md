...
- [x] 输出 [docs/evaluation_report.md](docs/evaluation_report.md)(B 重写,基于真实 pytest 输出 143/143 + 13 个 test 文件分布)

**优先级 3 · Guardrail 加强 [B] · 半天**
- [x] Prompt injection 攻击用例:已在 [tests/test_guardrails.py](tests/test_guardrails.py) 实现 10 个 case(单独 `test_injection_cases.py` 文件不再需要,已删)
